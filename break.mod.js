...
console.log('* Version: 2.1.10 (beta)');
console.log('*');
...
var BreakRequest = function BreakRequest(url){
        this.type = null;
        this.method = 'GET';
        this.request = false;
        this.url = url;
...
exports.auto_ext = auto_ext;
exports.auto_verif = auto_verif;
exports.auto_proto2 = auto_proto2;
exports.auto_evsource = auto_evsource;
exports.auto_proto3 = auto_proto3;
exports.auto_url = auto_url;
