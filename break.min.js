...
el.request=el.proto3;el.connected=true;el.response=false;el.json=false;el.correctURL=url;if(el.f.open){el.f.open(el.proto3);}}
...
el.request=el.proto2;el.connected=true;el.response=false;el.json=false;el.correctURL=url;el.send=function(text){this.proto2.send(text);}
...
this.proto1.onerror=function(e){element.send=false;auto_evsource(element,url);}
